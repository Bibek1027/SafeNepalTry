...
public class NotificationDAO {
    ...
    /**
     * description: Fetch all notifications for a specific user (newest first)
     *
     * @param userId
     * @return
     * @throws SQLException
    ...
    /**
     * description: Fetch only the latest 5 unread notifications for navbar dropdown
     *
     * @param userId
     * @return
     * @throws SQLException
    ...
    /**
     * description: Count unread notifications for a specific user (used for badge)
     *
     * @param userId
     * @return
     * @throws SQLException
    ...
    /**
     * description: Helper method: map a ResultSet row to a Notification object
     *
     * @param rs
     * @return
     * @throws SQLException
